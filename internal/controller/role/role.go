...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	...
	r := managed.NewReconciler(mgr, resource.ManagedKind(iamv1alpha1.RoleGroupVersionKind), opts...)
...
func (e *external) isUpToDate(cr *iamv1alpha1.Role, role *iam.Role) bool {
