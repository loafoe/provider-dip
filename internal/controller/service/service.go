...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(iamv1alpha1.ServiceGroupKind)
	...
	r := managed.NewReconciler(mgr, resource.ManagedKind(iamv1alpha1.ServiceGroupVersionKind), opts...)

	return ctrl.NewControllerManagedBy(mgr).
		Named(name).
		WithOptions(o.ForControllerRuntime()).
		WithEventFilter(resource.DesiredStateChanged()).
		For(&iamv1alpha1.Service{}).
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	service, _, err := e.client.IAM.Services.GetServiceByID(externalName)
	if err != nil {
...
func (e *external) isUpToDate(cr *iamv1alpha1.Service, service *iam.Service) bool {
